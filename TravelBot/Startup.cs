...
using TravelBot.Dialogs.WelcomeDialog;
...
namespace TravelBot
{
    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSingleton(sp => new LuisServices(botConfig));
            ...
            services.AddSingleton(sp => new MicrosoftTranslator(translatorKey));
            ...
            services.AddSingleton(sp =>
            {
                ...
                var accessors = new WelcomeUserStateAccessors(userState)
                {
                    ...
                    ConversationDialogState = userState.CreateProperty<DialogState>("conversationDialogState"),
                    HotelSearchState = userState.CreateProperty<HotelReservation>("hotelSearchState"),
                };
